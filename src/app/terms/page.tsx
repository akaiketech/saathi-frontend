    ...
    <main className="flex min-h-screen flex-col items-center mt-6">
      ...
      <footer className="mt-16 flex justify-evenly items-center w-full">
        <div
          ...
          } shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[60px] bg-[#ff725e] text-white text-[50px] not-italic font-bold leading-[normal] px-8 py-4 flex justify-between items-center`}
        >
          {loading ? "Loading..." : "ACCEPT"}{" "}
          {/* Show loading text when loading */}
          {!loading && ( // Show the SVG only when not loading
            <span className="pl-4">
              <svg
